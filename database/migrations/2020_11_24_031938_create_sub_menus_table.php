...
class CreateSubMenusTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sub_menus', function (Blueprint $table) {
            ...
            $table->string('status')->default(\App\Models\PmsModels\Menu\SubMenu::ACTIVE);
            $table->string('slug')->nullable();
            $table->string('menu_for')->default(\App\Models\PmsModels\Menu\SubMenu::ADMIN_MENU);
            $table->string('open_new_tab')->default(\App\Models\PmsModels\Menu\SubMenu::NO_OPEN_NEW_TAB);
