...
class CreateSubSubMenusTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sub_sub_menus', function (Blueprint $table) {
            ...
            $table->string('status')->default(\App\Models\PmsModels\Menu\SubSubMenu::ACTIVE);
            $table->string('slug')->nullable();
            $table->string('menu_for')->default(\App\Models\PmsModels\Menu\SubSubMenu::ADMIN_MENU);
            $table->string('open_new_tab')->default(\App\Models\PmsModels\Menu\SubSubMenu::NO_OPEN_NEW_TAB);
