            ...
            <div class="invoice-details mt25 row">
                ...
                <div class="col-6">
                    <ul class="list-unstyled mb0 pull-right">
                        ...
                        <li><strong>{{__('Generated By')}}:</strong> {{$quotation->relRequestProposal->createdBy->name}}</li>

                        <li>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="quotation_id" id="is_approved_{{$quotation->id}}" value="{{$quotation->id}}" required>
