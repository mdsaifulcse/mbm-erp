                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group form-group-lg mb-3 d-">
                                    <textarea name="term_condition" id="term_condition" class="form-control rounded" rows="3" placeholder="{{__('Term & Condition Here')}}">{!! old('term_condition',$supplier->term_condition) !!}</textarea>
