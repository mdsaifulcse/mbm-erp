                    ...
                    <div class="table-responsive ">
                        <table class="table table-striped table-bordered table-head" cellspacing="0" width="100%" id="dataTable">
                            ...
                            <tbody>
                                ...
                                @foreach($return_list as $key=>$grn)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    ...
                                    <td>
                                        <?php $count= $grn->relGoodsReceivedItems()->where('quality_ensure','return')->count(); ?>
                                        @if($count > 0)
                                        <a href="{{route('pms.quality.ensure.return.single.list',$grn->id)}}" class="btn btn-sm btn-info">{{__('QE Return Items')}} ({{$count}})</a>
                                        @endif
                                    </td>
