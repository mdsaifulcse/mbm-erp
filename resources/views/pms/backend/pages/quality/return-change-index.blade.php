                    ...
                    <div class="table-responsive ">
                        <table class="table table-striped table-bordered table-head" cellspacing="0" width="100%" id="dataTable">
                            ...
                            <tbody>
                                ...
                                @if(count($return_change_list)>0)
                                @foreach($return_change_list as $key=>$grn)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        @if($count > 0)
                                        <a href="{{route('pms.quality.ensure.return.change.single.list',$grn->id)}}" class="btn btn-sm btn-info">{{__('QE Return Change Items')}} ({{$count}})</a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
