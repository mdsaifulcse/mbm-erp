    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Production Bonus </li>
                <li class="top-nav-btn">
                    <a href="{{url('hr/operation/production-bonus-list')}}" class="btn btn-sm btn-primary">List <i class="las la-list"></i> </a>
                </li>
            </ul><!-- /.breadcrumb --> 
        </div>
        ...
        <div class="panel panel-info">
            <div class="panel-body">
                <form role="form" method="POST" action="{{ url('hr/operation/production-bonus') }}" enctype="multipart/form-data" class="row needs-validation justify-content-center" novalidate> 
                    <div class="col-6">
                                ...
                                <table id="AssociateTable" class="table header-fixed1 table-compact table-bordered col-sm-12">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="sticky-th">Ocacle ID</th>
                    ...
                    <div class="col-3 pt-2">
                        <div class="form-group has-required has-float-label">
                            <input type="month" name="month" id="month" value="{{date('Y-m')}}" placeholder="Select Month" required class="form-control">
                            <label  for="month" style="color: maroon;">Month  </label>
                        </div>
                        <div class="form-group has-required has-float-label">
                            <input type="amount" name="amount" id="amount" value="" placeholder="Enter amount" required class="form-control">
