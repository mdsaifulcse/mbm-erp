...
<div class="main-content">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <div id="single-date">
                                          <div class="form-group has-float-label has-required">
                                            <input type="month" class="report_date  form-control" id="year_month" name="year_month" placeholder="Y-m" required="required" value="{{ Request::get('date')??date('Y-m') }}" autocomplete="off" />
                                ...
                                {{--             <div class="col">
                                    ...
                                    {{--           <div class="col-6">
                                        ...
                                        <div class="form-group">
                                          <button class="btn btn-primary nextBtn btn-lg pull-right"  onClick="filter()" type="button" ><i class="fa fa-save"></i> Generate</button>
                                        </div>
                                    </div>   
                                </div>
                                {{-- <div class="row">
 ...
 --}}
                        ...
                        <div class="result-data" id="result-data">
                            <ul class="breadcrumb">
                                   <button type="button" class="btn btn-sm btn-primary modal-print" onclick="printDiv('result')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Print Report"><i class="las la-print"></i> </button>
                               </ul>
                ...
                <div class="col">
                  <div class="iq-card" id="result-section" style="display: none">
                    ...
                    <div class="iq-card-body no-padding" id="print-area">
                      ...
                      <div class="result-66" id="66-data">
