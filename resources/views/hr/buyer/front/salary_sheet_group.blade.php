                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p style="margin:0;padding:0">
                                                    ...
                                                    <span style="text-align: right;width: 30%; float: right;  white-space: wrap;"><font style="color:hotpink">
                                                        ...
                                                        {{ Custom::engToBnConvert(number_format($list->adv_deduct,2)??'0.0') }}
                                                ...
                                                <p style="margin:0;padding:0">
                                                    ...
                                                    <span style="text-align: right;width: 30%; float: right;  white-space: wrap;">
                                                        ...
                                                        {{ Custom::engToBnConvert(number_format($list->cg_deduct,2)??'0.0') }}
                                                ...
                                                @if($list->as_location == 7)
                                                    ...
                                                    <p style="margin:0;padding:0">
                                                        ...
                                                        <span style="text-align: right;width: 30%; float: right;  white-space: wrap;"><font style="color:hotpink">
                                                            {{ Custom::engToBnConvert(number_format($list->food_deduct,2)??'0.0') }}
                                                          </font>
                                                        </span>
                                                    </p>
                                                ...
                                                <p style="margin:0;padding:0">
                                                    ...
                                                    <span style="text-align: right;width: 30%; float: right;  white-space: wrap;"><font style="color:hotpink">
                                                            {{ Custom::engToBnConvert(number_format($list->others_deduct,2)??'0.0') }}
                                                    </font>
                                                    </span>
                                            ...
                                            <td>
                                                <p style="margin:0;padding:0">
                                                      ...
                                                      <span style="text-align: right;width: 5%; float: left;white-space: wrap;color: hotpink;">=</span>
                                                      <span style="text-align: right;width: 30%; float: right;  white-space: wrap;">
                                                            <font style="color:hotpink"> {{ Custom::engToBnConvert(number_format($list->salary_payable??0,2)) }}</font>
                                                     </span>
                                                </p>
                                                <p style="margin:0;padding:0">
                                                ...
                                                <p style="margin:0;padding:0">
                                                    ...
                                                    <span style="text-align: left; width: 65%; float: left;  white-space: wrap;">বেতন/সমন্বয়</span>
                                                    <span style="text-align: right;width: 5%; float: left;white-space: wrap;color: hotpink;">=
                                                    </span>
                                                    <span style="text-align: right;width: 30%; float: right;  white-space: wrap;">
                                                        <font style="color:hotpink">
                                                                {{ Custom::engToBnConvert(number_format($list->salary_add,2)??'0.0') }}
                                                        </font>
                                                    </span>
                                                    ...
                                                    <span style="text-align: right;width: 30%; float: right;  white-space: wrap;">
                                                        <font style="color:hotpink">
                                                            ...
                                                            @php 
                                                                ...
                                                                if(isset($list->partial_amount) && $list->partial_amount > 0){
                                                                    $salaryAdjustDeduct += $list->partial_amount??0;
                                                                }
                                                            @endphp
                                                ...
                                                @php
                                                    $salaryAdjustAmount = 0;$bonusAdjustAmount = 0;
                                                @endphp
                                                @if(isset($salaryAdjust[$list->associate_id][3]))
                                                <p style="margin:0;padding:0">
                                                    @php 
                                                        $salaryAdjustAmount = $salaryAdjust[$list->associate_id][3]->sum;
                                                    @endphp
                                                    ...
                                                    <span style="text-align: right;width: 30%; float: right;  white-space: wrap;">
                                                        <font style="color:hotpink">
                                                            {{ eng_to_bn(number_format($salaryAdjustAmount, 2) ??'0.00') }}
                                                        </font>
                                                    </span>

                                                </p>
                                                @endif
                                                @if(isset($salaryAdjust[$list->associate_id][4]))
                                                    <p style="margin:0;padding:0">
                                                        @php 
                                                            $bonusAdjustAmount = $salaryAdjust[$list->associate_id][4]->sum;
                                                        @endphp
                                                        ...
                                                        <span style="text-align: right;width: 30%; float: right;  white-space: wrap;">
                                                            <font style="color:hotpink">
                                                                {{ eng_to_bn(number_format($bonusAdjustAmount, 2) ??'0.00') }}
                                                            </font>
                                                        </span>
                                                ...
                                                @endif
                                                @php
                                                    $totalSalaryAdjust += ($salaryAdjustAmount + $bonusAdjustAmount); 
                                                @endphp
                                                <p style="margin:0;padding:0">
                                            ...
                                            <td style="text-align: center;">
                                                @php
                                                    $loc_emp++;
                                                    $totalSalary = ($list->total_payable+$salaryAdjustAmount + $bonusAdjustAmount);
        ...
        <div id="unit-info">
            <table class="table" style="width:100%;border-bottom:1px solid #ccc;margin-bottom:0;font-size:12px;color:lightseagreen;text-align:left" cellpadding="5">
                <tr>
                    ...
                    @php
                        $totalSalaryAd = $pageHead->totalSalary + $totalSalaryAdjust;
                        $fraction = ($totalSalaryAd + $pageHead->totalAdvanceAmount) - ($totalPayable + $pageHead->totalOTAmount +$attendanceBonus);
                        $fraction = $fraction<0?0:$fraction;
                        $fraction = number_format((float)$fraction, 2, '.', '');
                    @endphp
                    @if($fraction > 0 || $pageHead->totalAdvanceAmount > 0)
                    <td style="width:19%;">
                        <p style="margin:0;padding: 0"><strong> অগ্রিম সমন্বয়: </strong>
                            {{ eng_to_bn(bn_money($pageHead->totalAdvanceAmount)) }}
                        </p>
                    ...
                    <td style="width:25%; text-align:right;">
                        <p style="margin:0;padding: 0"><strong>সর্বমোট টাকার পরিমানঃ </strong>
                            {{ Custom::engToBnConvert(bn_money($totalSalaryAd)) }}
                        </p>
                    </td>
