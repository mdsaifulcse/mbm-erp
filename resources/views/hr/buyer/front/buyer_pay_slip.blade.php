                            ...
                            @if( $list != null)
                                ...
                                <tr>
                                    ...
                                    <td  style="width: 12%;text-align: right; color:hotpink;" >
                                        ...
                                        <p>&nbsp;&nbsp;&nbsp; {{Custom::engToBnConvert($list->adv_deduct + $list->food_deduct + $list->cg_deduct + $list->others_deduct)}} =/টঃ</p>
                                        <p>
                                            @php
                                                $advanceDeductAmount = 0;
                                                if(isset($list->partial_amount) && $list->partial_amount > 0){
                                                    $advanceDeductAmount += $list->partial_amount??0;
                                                }
                                            @endphp
                                        ...
                                        <p>&nbsp;&nbsp;&nbsp;{{ Custom::engToBnConvert($list->salary_add) }} =/টঃ</p>
