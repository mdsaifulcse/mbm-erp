    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"> Incentive Info</li>
            </ul>
        </div>
        ...
        <div class="page-content"> 
            <div class="row">
                <div class="col">
                  <form role="form" method="get" action="{{ url("hr/reports/incentive-bonus-report") }}" id="formReport">
                    @csrf
                      ...
                      <div class="iq-card-header d-flex mb-0">
                         <div class="iq-header-title w-100">
                            <div class="row">
                              ...
                              <input type="hidden" id="reportFormat" name="report_format" value="{{ Request::get('report_format') ?? '1' }}">
...
@section('right-nav')
  ...
  <div class="form-group has-float-label select-search-group">
    {{ Form::select('pay_type', [0=>'Due', 1=> 'Paid'], 0, ['placeholder'=>'Select Pay Type', 'class'=>'form-control capitalize select-search', 'id'=>'payType']) }}
