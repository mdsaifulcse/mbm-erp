        ...
        <div id="report_section" class="report_section">
            ...
            <div class="top_summery_section">
                ...
                <div class="page-header">
                    <h2 style="margin:4px 10px; font-weight: bold; text-align: center;">@if($btype != '') {{ $billType[$btype] }} @endif Bill  @if($input['report_format'] == 0) Details @else Summary @endif Report Report </h2>
                    ...
                    <table class="table table-bordered table-hover table-head" style="width:100%;border:1px solid #ccc;margin-bottom:0;font-size:14px;text-align:left" border="1" cellpadding="5">
                        <thead style="font-weight: bold; font-size:14px; text-align: center;">
                            ...
                            <tr>
                                ...
                                <th style=" font-weight: bold; font-size:13px;">Unit</th>
                                <th style=" font-weight: bold; font-size:13px;">ID</th>
                                <th style=" font-weight: bold; font-size:13px;">Name</th>
                                <th style=" font-weight: bold; font-size:13px;">OT/Non-OT</th>
                                ...
                                <th style=" font-weight: bold; font-size:13px;">Bill Amount</th>
                        ...
                        <!-- custom design for all-->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        {{ round($groupSal->billAmount - $groupSal->paidAmount) }}
                                    </td>
                                </tr>
                                @endforeach
                                <tr>
                                    ...
                                    <td class="text-right fwb" style="font-weight: bold; font-size:13px;">{{ round($summary->totalBill) }}</td>
                                    ...
                                    <td class="text-right fwb" style="font-weight: bold; font-size:13px;">{{ round($summary->totalBill - $summary->totalPaidAmount) }}</td>
                                </tr>
