                                    ...
                                    <div class="col-4">
                                        ...
                                        <div id="double-date" >
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group has-float-label has-required" id="todate_div">
                        ...
                        <div class="iq-card-header d-flex mb-0">
                            <div class="iq-header-title w-100">
                                <div class="row">
                                  ...
                                  <div class="format">
                                    <div class="form-group has-float-label select-search-group mb-0" id="report_header">
                                        <?php
...
/*
                            .table{width: 100%;}a{text-decoration: none;}.table-bordered {border-collapse: collapse;}.table-bordered th,.table-bordered td {border: 1px solid #777 !important;padding:3px;}.no-border td, .no-border th{border:0 !important;vertical-align: top;}.f-16 th,.f-16 td, .f-16 td b{font-size: 16px !important;}*/
                        </style>
          ...
          if(flag === 0){
            ...
            else if (type == 'hourly_ot_lnf')
            {
                ...
                $("#report_header").hide();
                 ...
                 url = '{{ url("hr/reports/hourly_ot_lnf") }}';
            }
...
$("#latecount").val(4).trigger('change');
    ...
    $(document).on('click','#viewletter', function(){
       ...
       console.log(manager);
            ...
            if (manager==='null' ) {
                $("#managerdiv .select2-container .select2-selection__rendered").css({
                    'border': '1px solid red',
                    'border-radius': '5px',
                    'height': '28px'
                });
                $.notify('Select Signatory Manager Name', 'error');
                }else{
                $("#managerdiv .select2-container .select2-selection__rendered").css({
    ...
    function viewletter(id = null) {
         console.log('ok2');
    $('#content-result-drawer').html(loaderContent);
    $("#right_modal_lg_drawer").modal();
    $.ajax({
    type:'get',  
    url: '{{url("hr/reports/viewletter/")}}/'+id,   
    data:{
    'to_date':$('#to_date').val(),
    ...
    success:function(data){
        console.log('ok2');
        $('#content-result-drawer').html(data);
    }
    });
    }
