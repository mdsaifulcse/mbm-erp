		...
		<div class="report_section" id="report_section">
			...
			<div class="top_summery_section">
		        ...
		        <div class="page-header-summery">
        			...
        			@endif
        			<h4>Leave Date: {{ $input['date']}}</h4>
        			<h4>Total Leave : <b>{{ $totalEmployees }}</b></h4>
			...
			<div class="content_list_section">
				@if($input['report_format'] == 0)
					...
					@foreach($uniqueGroupEmp as $group => $employees)
			            ...
			            @else
				            <tr>
				            	<td colspan="11" class="text-center">No Leave Employee Found!</td>
				            </tr>
			            @endif
				...
				@elseif(($input['report_format'] == 1 && $format != null))
					...
					<table class="table table-bordered table-hover table-head">
						...
						<tbody>
							...
							@else
							<tr>
				            	<td colspan="{{ ($format == 'as_subsection_id' || $format == 'as_subsection_id')?'5':'3'}}" class="text-center">No Leave Employee Found!</td>
				            </tr>
							@endif
						</tbody>
