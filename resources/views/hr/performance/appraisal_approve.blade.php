		...
		<div class="page-content"> 
            ...
            <div class="row">
                ...
                {{ Form::open(['url'=>'hr/performance/appraisal_approve/approve_reject', 'class'=>'form-horizontal', 'method'=>'POST']) }}
                    ...
                    <div class="col-xs-12">
                        <legend style="text-indent: 100px;"><b style="font-size: 15px;">Reflection of Performance</b></legend>
                    <div class="col-xs-3"></div>
                    ...
                    <div class="col-xs-12"><br><br></div>
                    <div class="col-xs-12">
                        <legend style="text-indent: 100px;"><b style="font-size: 15px;">Primary Assesment</b></legend>
                    <div class="col-xs-3"></div>
