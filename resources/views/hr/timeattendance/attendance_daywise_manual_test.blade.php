                    ...
                    <div class="col-sm-12" style="padding: 0px;">
                        <form role="form" method="get" action="{{ url('hr/timeattendance/daywise_manual_attendance') }}" id="searchform">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-3 no-padding-left" >
                                    <label class="col-sm-5 control-label no-padding-right" for="area"> Area <span style="color: red">&#42;</span> </label>
                                    <div class="col-sm-7 no-padding-right" >
                                       {{ Form::select('area', $areaList, Request::get('area'), ['placeholder'=>'Select Area', 'id'=>'area','class'=> 'col-xs-12','style'=> 'width:100%', 'data-validation'=>'required', 'data-validation-error-msg'=>'The Area field is required']) }}  
                                   </div>
                                </div>
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <div class="col-sm-3 no-padding-left" >
                                    <label class="col-sm-5 control-label no-padding-right" for="area"> Department  <span style="color: red">&#42;</span> </label>
                                    <div class="col-sm-7 no-padding-right" >
                                       {{ Form::select('department', !empty(Request::get('area'))?$deptList:[], Request::get('department'), ['placeholder'=>'Select Department ', 'id'=>'department','class'=> 'col-xs-12', 'style'=> 'width:100%', 'data-validation'=>'required', 'data-validation-error-msg'=>'The Department field is required']) }} 
                                   </div>
                                </div>
                                <div class="col-sm-3 no-padding-left" >
                                ...
                                <div class="col-sm-3 no-padding-left" >
                                    ...
                                    <div class="col-sm-7 no-padding-right" >
                                       <input type="date" name="report_date" id="report_date" class="col-xs-12" value="{{ Request::get('report_date') }}" data-validation="required" data-validation-error-msg="The Date field is required"/> 
                                   </div>
                                </div>
