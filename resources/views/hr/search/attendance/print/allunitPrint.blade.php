...
<div id="full_body_area">
	<div id="header_area">
		...
		<h3 style="margin-top: 5px; margin-bottom: 5px;">Attendance Report (Unit Wise)</h3>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					@php
						unset($response[$unit['hr_unit_id']]['attendance']);
					@endphp
					@foreach($response[$unit['hr_unit_id']] as $k=>$single)
						@php
							if($k=='present') {
								$present += $single;
							}
