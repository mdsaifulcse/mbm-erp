...
<div id="full_body_area">
	<div id="header_area">
		...
		<h3 style="margin: 5px 0px;">Attendance Report (Area Wise)</h3>
	...
	<div id="body_area">
		<table>
			...
			<tbody>
				...
				<tr>
					<td>{{$area['hr_area_name']}}</td>
					@php
						unset($response[$area['hr_area_id']]['attendance']);
					@endphp
					@foreach($response[$area['hr_area_id']] as $k=>$single)
						@php
							if($k=='present') {
								$present += $single;
							}
