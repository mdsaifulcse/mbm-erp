       ...
       <div class="col-lg-10 mail-box-detail">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h6>
                        Department
                        <a class="btn btn-outline-primary pull-right" href="#list"><i class="fa fa-list"></i> Department List</a>
                    </h6>
                </div> 
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group has-required has-float-label select-search-group">
                                    {{ Form::select('hr_department_area_id', $areaList, null, ['placeholder' => 'Select Area Name', 'class' => 'form-control', 'id'=>'hr_department_area_id', 'required'=>'required']) }}
                                    <label  for="hr_department_area_id" > Area Name </label>
                                </div>

                                <div class="form-group has-required has-float-label">
                                    <input type="text" name="hr_department_name" id="hr_department_name" placeholder="Department Name" class="form-control" required="required"/>
                                    <label  for="hr_department_name" > Department Name </label>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group has-required has-float-label">
                                    <input type="text" name="hr_department_name_bn" id="hr_department_name_bn" placeholder="ডিপার্টমেন্টের নাম " class="form-control" required="required"/>
                                    <label  for="hr_department_name_bn" >ডিপার্টমেন্ট (বাংলা) </label>
                                </div>

                                <div class="form-group has-required has-float-label">
                                    <input type="text" name="hr_department_code" placeholder="Department Code" class="form-control" required="required"/>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <input type="text" id="hr_department_min_range" name="hr_department_min_range" required="required" placeholder="Example: 000001 " class="form-control"  />
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" id="hr_department_max_range" name="hr_department_max_range" required="required" placeholder="Example: 001000" class="form-control"  />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group"> 
