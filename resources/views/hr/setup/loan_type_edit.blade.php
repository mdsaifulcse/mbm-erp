    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"> Edit Loan Type </li>
            </ul><!-- /.breadcrumb --> 
        </div>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" action="{{ url('hr/setup/loan_type_update')  }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="hr_loan_type_name" name="hr_loan_type_name" placeholder="Loan Type Name" class="form-control" required value="{{$loantype->hr_loan_type_name}}" />
                            </div>
                            <div class="form-group">
