       ...
       <div class="col-lg-10 mail-box-detail">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h6>
                        Section
                        <a class="btn btn-outline-primary pull-right" href="#list"><i class="fa fa-list"></i> Section List</a>
                    </h6>
                </div> 
                            ...
                            <div class="table-responsive">
                                <table id="global-datatable" class="table table-striped table-bordered" style="display: block;width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $areaList[$section->hr_section_area_id]??'' }}</td>
                                            <td>{{ $department[$section->hr_section_department_id]['hr_department_name']??'' }}</td>
