                                                ...
                                                @if($key == 'Digit')                                
                                                    ...
                                                    <div class="col-sm-1 col-xs-1" style="background-color: #dbdbdb; padding-right: 0">
                                                       <li class='col-sm-1 col-xs-1'>
                                                        <input type='checkbox' class='group-input-size' name="selected_size[]" id="size_{{ $g->id }}" value="{{ $g->id }}" {{ in_array($g->id,$s_id)!==false?'checked="checked':'' }} />
                                        ...
                                        <div class="col-sm-12 col-xs-12 each-new-dx" style="margin-top: 9px;background-color:<?= $color ?>;">
                                            ...
                                            @foreach($new_dx as $n_key=>$new_d)
                                                <li class='col-sm-2 col-xs-2' style="font-size: 12px;">
                                                    <input type='checkbox' class='group-input-size' name="selected_size[]" id="size_{{ $new_d->id }}" value="{{ $new_d->id }}" {{ in_array($new_d->size,$s_id)!==false?'checked="checked':'' }} style="position: relative !important;margin-left: 3px !important;"/>
