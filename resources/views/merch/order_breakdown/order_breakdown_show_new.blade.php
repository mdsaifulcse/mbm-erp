                                                                ...
                                                                <tr style="background-color: {{ $poTrStyle }}">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @foreach($sizeList as $size)
                                                                            ...
                                                                            if($poSingle->po_id){
                                                                                if($poSingle->po_id == $size->po_id && $poSingle->clr_name == $size->clr_name){
                                                                                    $poSizeQty = $size->qty; @endphp 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($bom->po_no != null)
                                                        ...
                                                        @foreach($clrs as $clrId=>$clr)
                                                            @if(in_array($clrId, $clr_name))
                                                                {{ $cl  }} <br>
