	...
	<div class="main-content-inner">
		...
		<div class="page-content  table-responsive">
            ...
            <div class="panel panel-success">
            	<div class="panel-heading"><h6>Order Costing Edit
...
$(document).ready(function(){
	...
	// setTimeout(function(){
	// 	$('body').on('change','#total_sewing').change( function() {
	...
	*/
	...
	$(document).on("keyup change blur", ".fob, .lc, .freight, .unit_price", function(){
		...
		// console.log($('#total_sewing').val());
		// $('#total_sewing_n_finishing_price').val(0);
