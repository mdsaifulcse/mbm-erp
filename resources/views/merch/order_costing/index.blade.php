            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="top-nav-btn">
                        ...
                        href='{{ url("merch/order/costingSingleview/$order->order_id?export=excel") }}' 
                                        ...
                                        <div class='col-sm-12 table-wrapper-scroll-y table-custom-scrollbar'>
                                            ...
                                            <table class="table table-bordered table-hover table-fixed table-head"
                                                ...
                                                <tr class="text-center active">
                                                    ...
                                                    <th width="100" class="vertical-align">Color / Shade</th>
                                                    ...
                                                    @if(count($groupBom) > 0 && isset($groupBom[$itemCat->mcat_id]))
                                                        ...
                                                        @foreach($groupBom[$itemCat->mcat_id] as $itemBom)
                                                            ...
                                                            <tr id="itemRow-{{ $itemBom->mcat_id}}_{{ $itemBom->mr_cat_item_id }}{{ $itemBom->sl }}">
                                                                ...
                                                                <td>
                                                                    <p class="consumption" data-garments-qty="{{$itemBom->garments_qty}}">
                                                                        {{ $itemBom->consumption }}
                                                                    </p>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <input type="text" step="any" min="0"
                                                                          ...
                                                                          value="{{ number_format((float)$itemPrice, 4, '.', '')??'0' }}">
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td class="table-warning">
                                                                    <p class="text-right fwb">
                                                                        {{ number_format((float)$itemStyleUnitPrice, 4, '.', '') }}
                                                                    </p>
                                                                </td>
                                                                <td>
                                                        ...
                                                        <tr class="table-default">
                                                            <td colspan="14"><h5 class="capilize">
                                                ...
                                                <tbody>
                                                <tr class="table-default">
                                                    <td colspan="14"><h5 class="capilize">Total Sewing and Finishing
                                                ...
                                                @foreach($specialOperation as $spo)
                                                    <tr class="table-default">
                                                        <td colspan="6"><p class="capilize">{{ $spo->opr_name }}</p>
                                                        </td>
                                                        <td> 1</td>
                                                        <td> 0</td>
                                                        <td>
                                                ...
                                                @endforeach
                                                <tr class="table-default">
                                                    <td colspan="6"><p class="capilize">Testing Cost</p></td>
                                                    <td> 1</td>
                                                    <td> 0</td>
                                                    <td>Piece</td>
                                                    <td colspan="4"></td>
                                                ...
                                                <tr class="table-default">
                                                    <td colspan="6"><p class="capilize">CM</p></td>
                                                    <td> 1</td>
                                                    <td> 0</td>
                                                    <td>Piece</td>
                                                    <td colspan="4"></td>
                                                ...
                                                <tr class="table-default">
                                                    <td colspan="9"><p class="capilize">Commercial Cost</p></td>
                                                    <td colspan="4"></td>
                                                    <td>
                                                ...
                                                <tr class="table-default">
                                                    <td colspan="14"><h5 class="capilize">Net FOB</h5></td>
                                                    <td>
                                                ...
                                                <tr class="table-default">
                                                    <td colspan="6"><h5 class="capilize">Buyer FOB</h5></td>
                                                    <td>
                                                        <input type="text" step="any" min="0"
                                                ...
                                                <tr class="table-default">
                                                    <td colspan="6"><h5 class="capilize">Agent FOB</h5></td>
                                                    <td>
                                                        <input type="text" step="any" min="0"
                                                ...
                                                <tr class="table-default">
                                                    <td colspan="14" class="tsticky-bottom"><h5 class="capilize ">Total
                                                            FOB</h5></td>
