                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group has-float-label select-search-group">
                                            {{ Form::select('mr_sample_style[]', $sampleType, $samples, ['id'=>'mr_sample_style', 'class'=> 'form-control ','multiple']) }}
                                     ...
                                     {{-- <div class="form-group file-zone notification-info ">
                                        <label> Uploaded file </label>
                                            ...
                                            <td width="50%"><a href="{{ asset($style->techpack) }}" target="blank" class="btn btn-lg btn-primary"><i class="las la-eye"></i></a>
                                            </td>
                                            <td width="50%">{{(!empty("Style Details.pdf")?'Style Details.pdf':'No Name') }}</td>
                                    </div>  --}}   
                                        {{-- </div> --}}
                                       {{--  @php dd($sampleType); @endphp --}}
