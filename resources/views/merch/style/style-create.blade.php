                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group has-float-label " id="style-form">
                                            <input type="text" id="stl_no" name="stl_no" placeholder="Style Reference 1" class="col-xs-12 form-control" autocomplete="off" />
                                        ...
                                        <div class="form-group has-float-label ">
                                            <input type="text" id="stl_product_name" name="stl_product_name" placeholder="Style Reference 2" autocomplete="off" class=" form-control"  />
