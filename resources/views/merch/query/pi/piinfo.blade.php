    	...
    	<div class="row choice_2_div" id="choice_2_div" name="choice_2_div">
	        <div class="row">
				...
				<div class=" col-xs-6 col-sm-3 pricing-box">
					<div class="widget-box widget-color-green2 search_buyer" style="height:122px;">
						<div class="widget-header">
				...
				<div class=" col-xs-6 col-sm-3 pricing-box">
					<div class="widget-box widget-color-green2 search_supplier" style="height:122px;">
						<div class="widget-header">
				...
				<div class=" col-xs-6 col-sm-3 pricing-box">
					<div class="widget-box widget-color-green2 search_pi" style="height:122px;">
						<div class="widget-header">
							<h5 class="widget-title bigger lighter">PI</h5>
						</div>

						<div class="widget-body">
							<div class="widget-main center">
								<span class="infobox-data-number" style="margin: 10px 0 4px;"> {{$globalinfo->pi}}</span>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-offset-3 col-xs-6 col-sm-3 pricing-box">
					<div class="widget-box widget-color-green2 search_pi" style="height:122px;">
						<div class="widget-header">
							<h5 class="widget-title bigger lighter">PI Qty</h5>
						</div>

						<div class="widget-body">
							<div class="widget-main center">
								<span class="infobox-data-number" style="margin: 10px 0 4px;"> {{$globalinfo->qty}}</span>
							</div>
						</div>
					</div>
				...
				<div class=" col-xs-6 col-sm-3 pricing-box">
					<div class="widget-box widget-color-green2 search_pi" style="height:122px;">
						<div class="widget-header">
							<h5 class="widget-title bigger lighter">PI Value</h5>
						</div>
