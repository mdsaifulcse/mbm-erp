    	...
    	<div class="row choice_2_div" id="choice_2_div" name="choice_2_div">
	        <div class="row">
				...
				<div class=" col-xs-6 col-sm-3 pricing-box">
					...
					<div class="widget-box widget-color-green2 search_team" style="height:122px;">
						<div class="widget-header">
								<h5 class="widget-title bigger lighter">Team</h5>
						</div>

						<div class="widget-body">
							<div class="widget-main center">
								<span class="infobox-data-number" style="margin: 20px 0 4px;"> {{$globalinfo->team}}</span>
							</div>
						</div>
					</div>
					<div class="space-10"></div>
					<div class="widget-box widget-color-green2 search_unit" style="height:125px;">
						<div class="widget-header">
						...
						<div class="widget-body">
							<div class="widget-main center">
								<span class="infobox-data-number" style="margin: 20px 0 4px;"> {{$globalinfo->unit}}</span>
							</div>
						</div>
					</div>
