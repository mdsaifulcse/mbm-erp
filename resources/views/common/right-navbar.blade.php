...
<script type="text/javascript">
  ...
  function advFilter(){
    ...
    var curMeInputs = $("#filterForm").find("input[type='text'],input[type='email'],input[type='password'],input[type='url'],input[type='date'],input[type='checkbox'],input[type='radio'],textarea,select"),
    isValid = true;
    ...
    var curMeInputs = $("#formReport").find("input[type='text'],input[type='email'],input[type='password'],input[type='url'],input[type='date'],input[type='checkbox'],input[type='radio'],textarea,select");
    jQuery(".form-group").removeClass("has-error");
    for (var i = 0; i < curMeInputs.length; i++) {
       if (!curMeInputs[i].validity.valid) {
          isValid = false;
    ...
    if(isValid === true){
      ...
      var formAction = $("#formReport").attr("action"), formType = $("#formReport").attr("method");
