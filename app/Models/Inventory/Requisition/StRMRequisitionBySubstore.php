...
class StRMRequisitionBySubstore extends Model
{
    protected $table = "st_rm_requisition_by_substore";

    // $requisition_no need to pass to this function
    public static function fetchAllWithConnectivityByRequisitionNo(){
    	$data = DB::table('st_rm_requisition_by_substore as rp')->select([
    										'rp.*',
    										'odr.order_code',
    										'cat.item_name',
    										'art.art_name',
    									...
    									->leftJoin('st_rm_requisition_substore_item as pro_item', 
    									...
    									// ->where('rp.requisition_no','=', $requisition_no)
    									->get();
    	// foreach ($data as $d) {
