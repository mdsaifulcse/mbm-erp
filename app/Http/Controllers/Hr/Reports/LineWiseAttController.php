...
class LineWiseAttController extends Controller
{
    public function lineWiseAtt(Request $request){
    	...
    	foreach($info AS $employees){
    		...
    		$data= Attendance2::track($employees->associate_id, $request->unit_id, $request->report_date, $request->report_date);
    	...
    	return view('hr/reports/line_wise_att', compact('unitList', 'info','departments', 'unit_name', 'line_name', 'report_date','absent','present', 'lineList'));
    }
